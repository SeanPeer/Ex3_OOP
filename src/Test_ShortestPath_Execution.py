        ...
        for i in files:
            ...
            with open(i) as f:
                ...
                for e in data['Edges']:
                    ...
                    edges_no_weight.append((e['src'], e['dest']))
            ...
            nx_c_g = nx.DiGraph()
            nx_c_g.add_nodes_from(nodes)
            nx_c_g.add_edges_from(edges_no_weight)

            start = timeit.default_timer()
            start_ = time.perf_counter()

            a = nx.strongly_connected_components(nx_c_g)
            # for cc in a:
            #     print(cc)
